...
class TestSmokeTest():
  ...
  def test_adminPage(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("ack")
  ...
  def test_joinPage(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("Braxton")
    self.driver.find_element(By.NAME, "lname").send_keys("Hotton")
    self.driver.find_element(By.NAME, "bizname").send_keys("EP")
    self.driver.find_element(By.NAME, "biztitle").send_keys("Tech Support Eng")
